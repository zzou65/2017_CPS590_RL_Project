...
if_use_baseline = 1;
archi = [size(memo.prestate, 2), 50, 5];
...
net = DPN_Train_NN_2 ( archi, opts, memo, if_use_baseline, n_epoch, n_trajectory, disct_r, max_traj_len);
save('DPN_NNControl_Baseline.mat', 'net');
