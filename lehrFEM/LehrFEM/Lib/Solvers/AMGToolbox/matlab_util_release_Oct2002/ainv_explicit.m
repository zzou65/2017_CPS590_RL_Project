...
%
%Returns the approximate inverse matrix instead of the factors
%
%usage : Ainv=ainv_explicit(A,reorder,tol)
%
%See also  ainv
...
function Ainv=ainv_explicit(A,reorder,tol)

  [Z,D]=ainv(A,reorder,tol);
  Ainv=Z*inv(D)*Z.';
