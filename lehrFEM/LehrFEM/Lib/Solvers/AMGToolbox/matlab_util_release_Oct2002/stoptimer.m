...
function [time,fl,nintervals]=stoptimer(name)
...
%   t.elapsed=t.elapsed+[cputime,flops]-t.start;
  t.elapsed(1)=t.elapsed(1)+cputime-t.start(1);
  t.nintervals=t.nintervals+1;
  t.running=0;
end
...
internal_timer_data=setfield(internal_timer_data,name,t);
