function J = SmartFlux_LFE(u,Mesh,PsiHandle,QuadRule,SigmaHandle,varargin)
% SMARTFLUX_LFE Flux throu specified part of the boundary.
%
%   J = SMARTFLUX_LFE(U,MESH,PSIHANDLE,QUADRULE,SIGMAHANDLE) computes the
%   value J of the flux throu the boundary specified by the cut-off
%   function PSIHANDLE of the finite element solution U on the struct MESH
%   using the quadrature rule QUADRULE.
% 
%   J = SMARTFLUX_LFE(U,MESH,PSIHANDLE,QUADRULE,SIGMAHANDLE,SIGMAPARAM)
...
%   J = SmartFlux_LFE(u,Mesh,PsiHandle,QuadRule,SigmaHandle);
