function err = L1Err_LFE(Mesh,u,QuadRule,FHandle,varargin)
% L1ERR_LFE Discretization error in L1 norm for linear finite elements.
%
%   ERR = L1ERR_LFE(MESH,U,QUADRULE,FHANDLE) computes the discretization
...
%   Example:
%
%   err = L1Err_LFE(Mesh,u,QuadRule,fhandle);

%   Copyright 2005-2005 Patrick Meury & Christoph Wiesmeyr
