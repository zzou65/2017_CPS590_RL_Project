function err = L1Err_LFV(Mesh,u,QuadRule,FHandle,varargin)
% L1ERR_LFV Discretization error in L1 norm for linear finite volumes.
%
%   ERR = L1ERR_LFV(MESH,U,QUADRULE,FHANDLE) computes the discretization
...
%
%   ERR = L1ERR_LFV(MESH,U,QUADRULE,FHANDLE,FPARAM) also handles the
%   variable length argument list FPARAM to the exact solution FHANDLE.
%
%   Example:
%
%   err = L1Err_LFV(Mesh,u,QuadRule,fhandle);
%
