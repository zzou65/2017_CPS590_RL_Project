function err = L2Err_DGLFE(Mesh,u,QuadRule,FHandle,varargin)
% L2ERR_DGLFE Discretization error measured in the L2 norm for discontinuous
% Crouzeix-Raviart finite elements.
%
%   ERR = L2ERR_DGLFE(MESH,U,QUADRULE,FHANDLE) computes the discretization
...
%   Example:
%
%   err = L2Err_DGLFE(Mesh,u,QuadRule,Uex);
%
%   See also shap_DGLFE.
