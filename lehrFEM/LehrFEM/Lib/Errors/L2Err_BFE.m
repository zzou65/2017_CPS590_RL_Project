function err = L2Err_BFE(Mesh,u,QuadRule,FHandle,varargin)
% L2ERR_BFE Discretization error in L2 norm for bilinear finite elements.
%
%   ERR = L2ERR_BFE(MESH,U,QUADRULE,FHANDLE) computes the discretization
...
%
%   ERR = L2ERR_BFE(MESH,U,QUADRULE,FHANDLE,FPARAM) also handles the
%   variable length argument list FPARAM to the exact solution FHANDLE.
%
%   Example:
%
%   err = L2Err_BFE(Mesh,u,QuadRule,fhandle);
