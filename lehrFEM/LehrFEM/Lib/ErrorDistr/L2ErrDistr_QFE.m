function err = L2ErrDistr_QFE(Mesh,u,QuadRule,FHandle,varargin)
% L2ERRDISTR_QFE Discretization error distribution in L2 norm for quadratic
% finite element.
%
%   ERR = L2ERRDISTR_QFE(MESH,U,QUADRULE,FHANDLE) computes the discretization
...
%
%   ERR = L2ERRDISTR_QFE(MESH,U,QUADRULE,FHANDLE,FPARAM) also handles the
%   variable length argument list FPARAM to the exact solution FHANDLE.
%
%   Example:
%
%   err = L2ErrDistr_QFE(Mesh,u,QuadRule,fhandle);

%   Copyright 2005-2006 Patrick Meury & Kah Ling Sia & Mengyu Wang
