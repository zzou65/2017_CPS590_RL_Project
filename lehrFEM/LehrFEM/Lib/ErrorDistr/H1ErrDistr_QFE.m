function err = H1ErrDistr_QFE(Mesh,u,QuadRule,FHandle,varargin)
% H1ERRDISTR_QFE discretization error distribution in H1 norm for quadratic
% finite element.
%
%   ERR = H1ERRDISTR_QFE(MESH,U,QUADRULE,FHANDLE) computes the discretization
...
%
%   ERR = H1ERRDISTR_QFE(MESH,U,QUADRULE,FHANDLE,FPARAM) also handles the
%   variable length argument list FPARAM to the exact solution FHANDLE.
%
%   Example:
%
%   err = H1ErrDistr_QFE(Mesh,u,QuadRule,fhandle);
