function Loc = get_intEdges(Mesh)
% GET_BDEDGES Extract interior edges of the mesh.
%
%   LOC = GET_intEDGES(MESH) Extract boundary edge locations from the mesh.
%
...
%   Example:
%
%   loc = get_intEdges(Mesh);

%   Copyright 2005-2005 Patrick Meury and Sebastien Tordeux
