function L = assemLoad_Stokes_TH(Mesh,QuadRule,FHandle,varargin)
% ASSEMLOAD_STOKES_TH Assemble load vector for Taylor-Hood elements.
%
%   L = ASSEMLOAD_STOKES_TH(MESH,QUADRULE,FHANDLE) assembles the global
...
%
%   L = ASSEMLOAD_STOKES_TH(MESH,QUADRULE,FHANDLE,FPARAM) also handles
...
%   L = assemLoad_Stokes_TH(Mesh,P7O6(),FHandle);
%
%   See also shap_QFE.
...
%   CH-8092 Zurich, Switzerland
  ...
  L = zeros(2*(nCoordinates+nEdges)+nCoordinates+1,1);
