function [U,FreeDofs] = assemDir_Stokes_P2P0(Mesh,BdFlags,FHandle,varargin)
% ASSEMDIR_STOKES_P2P0 Dirichlet boundary conditions for P2 elements.
%
%   [U,FREEDOFS] = ASSEMDIR_STOKES_P2P0(MESH,BDFLAG,FHANDLE) incoporates
...
%   BDFLAG.
%
%   [U,FREEDOFS] = ASSEMDIR_STOKES_P2P0(MESH,BDFLAG,FHANDLE,FPARAM) also
...
%   Example:
%
%   [U,FreeDofs] = assemDir_Stokes_P2P0(Mesh,BdFlags,FHandle);
%
...
%   CH-8092 Zurich, Switzerland
  ...
  tmp_1 = [];
  tmp_2 = [];
  U = zeros(2*(nCoordinates+nEdges)+nElements+1,1);
  for j = BdFlags
  ...
  FreeDofs = [z1 ...
              ...
              2*(nCoordinates+nEdges)+(1:nElements) ...
              2*(nCoordinates+nEdges)+nElements+1];
