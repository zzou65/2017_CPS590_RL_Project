function [U,FreeDofs] = assemDir_LFE2(Mesh,BdFlags,FHandle,varargin)
% ASSEMDIR_LFE2 Dirichlet boundary conditions.
%
%   [U,FREEDOFS] = ASSEMDIR_LFE2(MESH,BDFLAG,FHANDLE) incoporates the
...
%
%   [U,FREEDOFS] = ASSEMDIR_LFE2(MESH,BDFLAG,FHANDLE,FPARAM) also
...
%   Example:
%
%   [U,FreeDofs] = assemDir_LFE2(Mesh,BdFlags,FHandle);
%
...
%   CH-8092 Zurich, Switzerland
  ...
  tmp = setdiff(1:nCoordinates,tmp);
  FreeDofs = [ tmp  tmp+nCoordinates ];
