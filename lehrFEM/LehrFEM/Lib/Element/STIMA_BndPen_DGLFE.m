function Jloc = STIMA_BndPen_DGLFE(Edge,Normal,BdFlag,Data,SHandle,varargin)
% STIMA_BNDPEN_DGLFE Element stiffness matrix for boundary penalty term.
%
%   JLOC = STIMA_BNDPEN_DGLFE(EDGE,NORMAL,BDFLAG,DATA,SHANDLE) computes the
%   entries of the element stiffness matrix for the boundary penalty term.
%
...
%   Jloc = STIMA_BndPen_DGLFE(Edge,Normal,BdFlags,Data,Sigma);
%
%   See also shap_DGLFE.
