function Lloc = LOAD_Vol_DGLFE(Vertices,ElemFlag,QuadRule,FHandle,varargin)
% LOAD_VOL_DGLFE Element load vector for volume load data.
%
%   LLOC = LOAD_VOL_DGLFE(EDGE,NORMAL,BDFLAG,DATA,QUADRULE,S,FHANDLE)
...
%
%   LLOC = LOAD_VOL_DGLFE(VERTICES,ELEMFLAG,QUADRULE,FHANDLE,FPARAM) also
...
%   Lloc = LOAD_Vol_DGLFE(Vertices,ElemFlag,P3O3(),F);
%
%   See also shap_DGLFE.
