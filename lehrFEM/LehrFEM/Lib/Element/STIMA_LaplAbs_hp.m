function Aloc = STIMA_LaplAbs_hp(Vertices,ElemInfo,EDofs,EDir,CDofs,QuadRule,Shap,FHandle,varargin)
% STIMA_LAPLABS_HP Element stiffness matrix for the Laplacian.
%
%   ALOC = STIMA_LAPLABS_HP(VERTICES,ELEMINFO,EDOFS,EDIR,CDOFS,QUADRULE,SHAP, ...
%   FHANDLE) computes the value of the element stiffness matrix for the
%   Laplacian with absolute term given by FHANDLE using hierarchical shape
%   functions.
%
