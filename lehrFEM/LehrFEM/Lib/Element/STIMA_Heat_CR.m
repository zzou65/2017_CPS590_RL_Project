function Aloc = STIMA_Heat_CR(Vertices,ElemInfo,QuadRule,FHandle,varargin)
% STIMA_HEAT_CR Element stiffness matrix for the stationary heat equation.
%
...
%   
%   ALOC = STIMA_HEAT_CR(VERTICES,ELEMINFO,QUADRULE,FHANDLE,FPARAM) also
...
%   QuadRule = P7O6_rule();
%   Aloc = STIMA_Heat_CR([0 0; 1 0; 0 1],0,QuadRule,FHandle);
%
