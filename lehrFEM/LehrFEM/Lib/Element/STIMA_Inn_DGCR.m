function Aloc = STIMA_Inn_DGCR(Edge,Normal,BdFlag,LData,RData,s,varargin)
% STIMA_INN_DG Element stiffness matrix for interior terms.
%
%   ALOC = STIMA_INN_DGCR(EDGE,NORMAL,BDFLAG,LDATA,RDATA,S) computes the
...
%   Example:
%
%   Aloc = STIMA_Inn_DGCR(Edge,Normal,BdFlags,LDatat,RData,1);
%
