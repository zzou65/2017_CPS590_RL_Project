function Aloc = STIMA_Bnd_DGCR(Edge,Normal,BdFlag,Data,s,varargin)
% STIMA_BND_DGCR Element stiffness matrix for boundary terms.
%
%   ALOC = STIMA_BND_DGCR(EDGE,NORMAL,BDFLAG,DATA,S) computes the entries
...
%   Example:
%
%   Aloc = STIMA_Bnd_DGCR(Edge,Normal,BdFlags,Data,1);
%
