function Lloc = LOAD_Neu_Bnd_PWDG_dual(Edge,Normal,Params,Data,QuadRule,omega,GHandle,varargin)
%LOAD_NEU_BND_PWDG_DUAL Element load vector for Neumann boundary cond.
%
...
%   Neumann boundary conditions for dual (mixed) discontinuous plane
%   waves.
%
...
%   n = orient*Normal;
  ...
  v0 = conj(v) + Params.b/(i*omega)*conj(tau);
