function Aloc = STIMA_LaplAbs_BFE(Vertices,ElemInfo,QuadRule,FHandle,varargin)
% STIMA_LAPLABS_BFE Element stiffness matrix for the Laplacian.
%
%   ALOC = STIMA_LAPLABS_BFE(VERTICES,ELEMINFO,QUADRULE,FHANDLE) computes
%   the element stiffness matrix for the data given by function handle
%   FHANDLE. 
%
...
%    
%   FHANDLE is the function handle to the coefficient function of the
%   absolute term.
%   
%   ALOC = STIMA_LAPLABS_BFE(VERTICES,ELEMINFO,QUADRULE,FHANDLE,FPARAM)
%   also handles the additional variable length argument list FPARAM to the
...
%   Aloc = STIMA_LaplAbs_BFE([0 0; 1 0; 1 1; 0 1],0,QuadRule,FHandle);
%
