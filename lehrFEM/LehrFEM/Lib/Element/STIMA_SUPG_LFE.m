function Aloc = STIMA_SUPG_LFE(Vertices, flag, QuadRule, VHandle, a,d1,d2, varargin)
...
%
%   Flag not used, needed for interface to assemMat_LFE
%
...
%   Example: Aloc = STIMA_Lapl_LFE([0 0; 1 0; 0 1]);

% This stiffness matrix provides the extra terms for SUPG stabilization to be
