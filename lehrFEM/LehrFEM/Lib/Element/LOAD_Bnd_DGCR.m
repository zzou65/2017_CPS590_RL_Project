function Lloc = LOAD_Bnd_DGCR(Edge,Normal,BdFlag,Data,QuadRule,s,SHandle, ...
                              FHandle,varargin)
% LOAD_BND_DGCR Element load vector for boundary boundary load data.
%
...
%
%   LLOC = LOAD_BND_DGCR(EDGE,NORMAL,BDFLAG,DATA,QUADRULE,SHANDLE,FHANDLE, ...
...
%   Lloc = LOAD_Bnd_DGCR(Edge,Normal,BdFlags,Data,gauleg(0,1,2),1,Sigma,F);
%
%   See also shap_DGCR, grad_shap_DGCR.
...
%   CH-8092 Zurich, Switzerland
  ...
  shap = shap_DGCR([QuadRule.x zeros(nPts,1)]);
