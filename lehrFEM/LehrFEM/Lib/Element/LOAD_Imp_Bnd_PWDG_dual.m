function Lloc = LOAD_Imp_Bnd_PWDG_dual(Edge,Normal,Params,Data,QuadRule,omega,GHandle,varargin)
%LOAD_IMP_BND_PWDG_DUAL Element load vector for impedance boundary cond.
%
...
%   impedance boundary conditions for dual (mixed) discontinuous plane
%   waves.
%
...
%   n = orient*Normal;
  ...
  v0 = (1-Params.d)/(i*omega)*conj(v) + Params.d/(i*omega)*conj(tau);
