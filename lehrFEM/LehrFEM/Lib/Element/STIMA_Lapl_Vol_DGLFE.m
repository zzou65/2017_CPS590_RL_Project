function Aloc = STIMA_Lapl_Vol_DGLFE(Vertices,varargin)
% STIMA_LAPL_VOL_DGLFE Element stiffness matrix for the Laplacian.
%
%   ALOC = STIMA_LAPL_VOL_DGCR(VERTICES) computes the element stiffness
%   matrix for the Laplacian using discontinuous linear Lagrangian finite
%   elements.
%
...
%   Example:
%
%   Aloc = STIMA_Lapl_Vol_DGLFE([0 0; 1 0; 0 1]);
