function Aloc = STIMA_Stokes_P1P0(Vertices,ElemInfo,nu,QuadRule,varargin)
% STIMA_STOKES_P1P0 Element stiffness matrix for the stokes problem.
%
%   ALOC = STIMA_STOKES_P1P0(VERTICES,ELEMINFO,NU,QUADRULE) computes the
...
%
%   nu = 1;   
%   Aloc = STIMA_Stokes_P1P0([0 0; 1 0; 0 1],0,nu,P7O6());
%
