function Jloc = STIMA_InnPen_DGLFE(Edge,Normal,BdFlag,LData,RData,SHandle,varargin)
% STIMA_INNPEN_DGLFE Element stiffness matrix for interior penalty term.
%
%   JLOC = STIMA_INNPEN_DGLFE(EDGE,NORMAL,BDFLAG,LDATA,RDATA,SHANDLE)
...
%   Jloc = STIMA_InnPen_DGLFE(Edge,Normal,BdFlags,LDatat,RData,Sigma);
