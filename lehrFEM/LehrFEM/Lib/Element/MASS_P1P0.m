function M = MASS_P1P0(Vertices,ElemInfo,QuadRule,FHandle,varargin)
% MASS_P0 Element mass matrix.
%
%   M = MASS_P1P0(VERTICES,ELEMINFO,QUADRULE,FHANDLE) computes the element
%   mass matrix using linear/constant Lagrangian finite elements.
%
...
%   
%   M = MASS_P1P0(VERTICES,ELEMINFO,QUADRULE,FHANDLE,FPARAM) also handles the
