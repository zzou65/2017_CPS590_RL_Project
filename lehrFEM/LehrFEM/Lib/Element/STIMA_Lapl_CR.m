function Aloc = STIMA_Lapl_CR(Vertices,varargin)
% STIMA_LAPL_CR Element stiffness matrix for the Laplacian.
%
%   ALOC = STIMA_LAPL_CR(VERTICES) computes the element stiffness matrix
...
%   Example:
%
%   Aloc = STIMA_Lapl_CR([0 0; 1 0; 0 1]);
