% Run script for error of L2 projection using linear finite element
...
% Run script for error of L2 projection using quadratic finite element
...
%   CH-8092 Zurich, Switzerland
    ...
    grid on
    set(gca,'XScale','log','YScale','log','XDir','reverse');
    title('\bfConvergence rate for L2 error of L2 projection(QFE)');
    xlabel('\bfh');
    ylabel('\bfEnergy error');
    legend(['\bf\lambda=' num2str(lambda(1))],['\bf\lambda=' num2str(lambda(2))],...
           ['\bf\lambda=' num2str(lambda(3))],['\bf\lambda=' num2str(lambda(4))],...
...
%     p = polyfit(log(M_W),log(Err_L2(:,1)),1);
    add_Slope(gca,'SouthEast',2);
    print('-depsc', 'rate_L2P_L2_QFE.eps');
    !gv rate_L2P_L2_QFE.eps &
    ...
    grid on
    set(gca,'XScale','log','YScale','log','XDir','reverse');
    title('\bfConvergence rate for H1 error of L2 projection (QFE)');
    xlabel('\bfh');
    ylabel('\bfEnergy error');
    legend(['\bf\lambda=' num2str(lambda(1))],['\bf\lambda=' num2str(lambda(2))],...
           ['\bf\lambda=' num2str(lambda(3))],['\bf\lambda=' num2str(lambda(4))],...
...
%     p = polyfit(log(M_W),log(Err_H1(:,1)),1);
    add_Slope(gca,'SouthEast',1);
    print('-depsc', 'rate_L2P_H1_QFE.eps');
    !gv rate_L2P_H1_QFE.eps &
...
%   CH-8092 Zurich, Switzerland
    ...
    grid on
    set(gca,'XScale','log','YScale','log','XDir','reverse');
    title('\bfConvergence rate for L2 error of H1 projection(LFE)');
    xlabel('\bfh');
    ylabel('\bfEnergy error');
    legend(['\bf\lambda=' num2str(lambda(1))],['\bf\lambda=' num2str(lambda(2))],...
           ['\bf\lambda=' num2str(lambda(3))],['\bf\lambda=' num2str(lambda(4))],...
...
%     p = polyfit(log(M_W),log(Err_L2(:,1)),1);
    add_Slope(gca,'SouthEast',2);
    print('-depsc', 'rate_H1P_L2_LFE.eps');
    !gv rate_H1P_L2_LFE.eps &
    ...
    grid on
    set(gca,'XScale','log','YScale','log','XDir','reverse');
    title('\bfConvergence rate for H1 error of H1 projection (LFE)');
    xlabel('\bfh');
    ylabel('\bfEnergy error');
    legend(['\bf\lambda=' num2str(lambda(1))],['\bf\lambda=' num2str(lambda(2))],...
           ['\bf\lambda=' num2str(lambda(3))],['\bf\lambda=' num2str(lambda(4))],...
...
%     p = polyfit(log(M_W),log(Err_H1(:,1)),1);
    add_Slope(gca,'SouthEast',1);
    print('-depsc', 'rate_H1P_H1_LFE.eps');
    !gv rate_H1P_H1_LFE.eps &
    
    % Clear memory
    
    clear all;
    
% Run script for error of H1 projection using quadratic finite element
...
%   CH-8092 Zurich, Switzerland
    ...
    grid on
    set(gca,'XScale','log','YScale','log','XDir','reverse');
    title('\bfConvergence rate for L2 error of H1 projection(QFE)');
    xlabel('\bfh');
    ylabel('\bfEnergy error');
    legend(['\bf\lambda=' num2str(lambda(1))],['\bf\lambda=' num2str(lambda(2))],...
           ['\bf\lambda=' num2str(lambda(3))],['\bf\lambda=' num2str(lambda(4))],...
...
%     p = polyfit(log(M_W),log(Err_L2(:,1)),1);
    add_Slope(gca,'SouthEast',2);
    print('-depsc', 'rate_H1P_L2_QFE.eps');
    !gv rate_H1P_L2_QFE.eps &
    ...
    grid on
    set(gca,'XScale','log','YScale','log','XDir','reverse');
    title('\bfConvergence rate for H1 error of H1 projection (QFE)');
    xlabel('\bfh');
    ylabel('\bfEnergy error');
    legend(['\bf\lambda=' num2str(lambda(1))],['\bf\lambda=' num2str(lambda(2))],...
           ['\bf\lambda=' num2str(lambda(3))],['\bf\lambda=' num2str(lambda(4))],...
...
%     p = polyfit(log(M_W),log(Err_H1(:,1)),1);
    add_Slope(gca,'SouthEast',1);
    print('-depsc', 'rate_H1P_H1_QFE.eps');
    !gv rate_H1P_H1_QFE.eps &
