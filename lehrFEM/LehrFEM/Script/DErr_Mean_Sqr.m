...
%   Q_Mean_meshwidth.eps,     Q_Mean_meshwidth.eps,
...
%       title(sprintf('Mesh on level %d',i),'fontsize',14);
       print('-depsc',sprintf('Q_Mean_mesh%d.eps',i));
     end
  ...
  print('-depsc','Q_Mean_meshwidth.eps');
  close(fig);
  !gv Q_Mean_meshwidth.eps &
