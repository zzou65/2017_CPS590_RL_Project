function err = L2ErrP_PC(Mesh,u,QuadRule,FHandle,varargin)
% L2ERR_LFE Discretization error in L2 norm for pecewise constant finite elements.
%
...
%   CH-8092 Zurich, Switzerland
  ...
  for i = 1:nElements
    ...
    err = err+sum(QuadRule.w.*abs(u_EX-u_FE).^2)*2;
