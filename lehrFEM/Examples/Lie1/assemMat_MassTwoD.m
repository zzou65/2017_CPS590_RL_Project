function varargout = assemMat_MassTwoD(Mesh, varargin)
% assemMat_MassTwoD Assemble diagonal MASS matrix.
%
%   A = assemMat_MassTwoD(Mesh,varargin) 
%   A = ASSEMMat_MasstwoD(MESH) .... and
%   returns the matrix in a sparse representation.
%
%   [I,J,A] = ASSEMMat_MassTwo
