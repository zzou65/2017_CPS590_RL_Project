function varargout = assemMat_ContrTwo(Mesh, v, varargin)
% assemMat_ContrTwo assemble contraction of twoforms.
%
%   A = ASSEMMat_ContrTwo(MESH,  v) .... and
%   returns the matrix in a sparse representation.
%
%   [I,J,A] = ASSEMMat_ContrTwo(MESH, v) .... assembles the global matrix 
