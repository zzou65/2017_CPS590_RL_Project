...
%   The plot of the discretization error against mesh width is saved into 
%   the file error_Newton_graded.eps and the plot of the error against
%   degres of freedom is saved as error_Newton_graded_DF.eps
...
print -depsc error_Newton_graded.eps
...
print -depsc error_Newton_graded_DF.eps