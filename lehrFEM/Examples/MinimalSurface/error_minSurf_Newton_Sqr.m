...
%   error_Newton_Sqr.eps and the plot of the error against degrees of
%   freedom is saved as error_Newton_Sqr_DF.eps
...
print -depsc error_Newton_Sqr.eps
...
print -depsc error_Newton_Sqr_DF.eps