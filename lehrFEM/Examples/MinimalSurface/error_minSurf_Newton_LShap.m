...
%   error_Newton_LShap.eps and the plot of the error against the degrees of
%   freedom is saved as error_Newton_LShap_DF.eps
...
print -depsc error_Newton_LShap.eps
...
print -depsc error_Newton_LShap_DF.eps