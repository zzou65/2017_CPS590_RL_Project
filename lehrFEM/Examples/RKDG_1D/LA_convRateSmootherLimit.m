...
% CH-8092 Zurich, Switzerland
  ...
  NPOINTS =10.*[1:2:10];   % Initial set of grid points
...
%              end
  ...
  print('-depsc', 'rate_L2_LASmootherLimit.eps');
  ...
  print('-depsc', 'rate_L1_LASmootherLimit.eps');
  ...
  add_Slope(gca,'SouthEast',p(1));
  print('-depsc', 'rate_Linf_LASmootherLimit.eps');
  clear all;