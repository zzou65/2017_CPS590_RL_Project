% Run script for burgers problem convergence plot.
...
% CH-8092 Zurich, Switzerland
  ...
  NPOINTS =4*3.*[1:4];   % Initial set of grid points
  ...
  print('-depsc', 'rate_L2_BurgerDiscontLimit.eps');
  ...
  print('-depsc', 'rate_L1_BurgerDiscontLimit.eps');
  ...
  print('-depsc', 'rate_Linf_BurgerDiscontLimit.eps');
  clear all;