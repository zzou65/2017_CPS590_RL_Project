...
%   M_QFE_v=assemMat_QFE(NewMesh,@MASS_QFEquad,P3O2());
   ...
   M_QFE_ex=assemMat_QFE(NewMesh,@MASS_QFEquad,P7O6());
...
%    U_2v(FreeDofs) = A_2v(FreeDofs,FreeDofs)\L_2v(FreeDofs);
   ...
   U_2ex(FreeDofs) = A_2ex(FreeDofs,FreeDofs)\L_2ex(FreeDofs);
...
%    err(i,6) = L2Err_QFE(NewMesh,U_2v,P7O6(),d.U_EX_Handle,0,a);
   ...
   err(i,5) = L2Err_QFE(NewMesh,U_2ex,P7O6(),d.U_EX_Handle,0,a);
%   err(i,9) = L2Err_QFE(NewMesh,U_supg,P7O6(),d.U_EX_Handle,0,a);
   ...
   err2(i,1) = H1SErr_QFE(NewMesh,U_0b,P7O6(),d.GRAD_U_EX_Handle,0,a);
  % err2(i,2) = H1SErr_QFE(NewMesh,U_1b,P7O6(),d.GRAD_U_EX_Handle,0,a);
  % err2(i,3) = H1SErr_QFE(NewMesh,U_1v,P7O6(),d.GRAD_U_EX_Handle,0,a);
   err2(i,2) = H1SErr_QFE(NewMesh,U_1m,P7O6(),d.GRAD_U_EX_Handle,0,a);
   err2(i,3) = H1SErr_QFE(NewMesh,U_1e,P7O6(),d.GRAD_U_EX_Handle,0,a);
   ...
   err2(i,5) = H1SErr_QFE(NewMesh,U_2ex,P7O6(),d.GRAD_U_EX_Handle,0,a);
   %err2(i,9) = H1SErr_QFE(NewMesh,U_supg,P7O6(),d.GRAD_U_EX_Handle,0,a);
   err2(i,6) = H1SErr_QFE(NewMesh,U1,P7O6(),d.GRAD_U_EX_Handle,0,a);
   err2(i,7) = H1SErr_QFE(NewMesh,U2,P7O6(),d.GRAD_U_EX_Handle,0,a);
   err2(i,8) = H1SErr_QFE(NewMesh,U3,P7O6(),d.GRAD_U_EX_Handle,0,a);
   
   Dofs(i)=size(NewMesh.Coordinates,1);
   
   %plot_QFE(U_2e,NewMesh); colorbar;
   %plot_QFE(U1,NewMesh);  colorbar;
...
%   add_Slope(gca,'Southwest',p(1),'g-');
  ...
  print -depsc './plots/L2rate0forms_qfe.eps'
...
%   add_Slope(gca,'Southwest',p(1),'g-');
  ...
  print -depsc './plots/H1semirate0forms_qfe.eps'
