function varargout = assemMat_QFE_BdLayer(Mesh,EHandle,varargin)
...
%   Copyright 2005-2008 Patrick Meury, Kah Ling Sia, Holger Heumann
...
%   CH-8092 Zurich, Switzerland
  ...
  if(nargout > 1)
    ...
    varargout{1} = sparse(I(1:range),J(1:range),A(1:range),nCoordinates+nEdges,nCoordinates+nEdges);      
  end
