% Initialize constants
 ...
 clear Mesh;
  ...
  for i = 1:NREFS
   ...
   err1(i,4) = L2Err_LFE(New_Mesh,U_u4,P7O6(),d.U_EX_Handle,0,a);
   err1(i,5) = L2Err_LFE(New_Mesh,U_s,P7O6(),d.U_EX_Handle,0,a);
   err1(i,6) = L2Err_LFE(New_Mesh,U_supg,P7O6(),d.U_EX_Handle,0,a)
   %
 ...
 p = polyfit(log(h(1:NREFS)),log(err1(1:NREFS,4)),1);
 ...
 p = polyfit(log(h(1:NREFS)),log(err1(1:NREFS,5)),1);
 add_Slope(gca,'NorthWest',p(1),'c-');
 p = polyfit(log(h(1:NREFS)),log(err1(1:NREFS,6)),1);
