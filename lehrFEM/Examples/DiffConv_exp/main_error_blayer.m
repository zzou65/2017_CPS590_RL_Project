...
%    l(i,1)=L2Err_LFE(NewMesh,I_1*(M_m\LU),P7O6(),d.V_GRAD_U_EX_Handle,0,a)
   ...
   err2(i,1) = L2Err_LFEmod(NewMesh,U_0b,P7O6(),d.U_EX_Handle,0,a);
   err2(i,2) = L2Err_LFEmod(NewMesh,U_1b,P7O6(),d.U_EX_Handle,0,a);
   err2(i,3) = L2Err_LFEmod(NewMesh,U_1v,P7O6(),d.U_EX_Handle,0,a);
   err2(i,4) = L2Err_LFEmod(NewMesh,U_1m,P7O6(),d.U_EX_Handle,0,a);
   err2(i,5) = L2Err_LFEmod(NewMesh,U_2b,P7O6(),d.U_EX_Handle,0,a);
   err2(i,6) = L2Err_LFEmod(NewMesh,U_2v,P7O6(),d.U_EX_Handle,0,a);
   err2(i,7) = L2Err_LFEmod(NewMesh,U_2m,P7O6(),d.U_EX_Handle,0,a);
   err2(i,8) = L2Err_LFEmod(NewMesh,U_2e,P7O6(),d.U_EX_Handle,0,a);
   err2(i,9) = L2Err_LFEmod(NewMesh,U_supg,P7O6(),d.U_EX_Handle,0,a);
   
   Dofs(i)=size(NewMesh.Coordinates,1);
   
   plot_LFE(U_1m,NewMesh); colorbar;
   plot_LFE(U_1v,NewMesh);  colorbar;
  ...
  print -depsc './plots/L2rate0formsI1_blayer.eps'
  ...
  print -depsc './plots/L2modrate0formsI1_blayer.eps'
  ...
  print -depsc './plots/L2rate0formsI2_blayer.eps'
  ...
  print -depsc './plots/L2modrate0formsI2_blayer.eps'
