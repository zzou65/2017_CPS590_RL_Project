function UP_loc = STIMA_UPQFE_QFE(Vertices, Flag, vHandle, varargin)
...
for i=1:Pts
    ...
    Elem =N(i,:)'* [-gradN(i,[1 2])*v', -gradN(i,[3 4])*v(1,:)', ....
                        -gradN(i,[5 6])*v', -gradN(i,[7 8])*v(1,:)', ....
                        -gradN(i,[9 10])*v', -gradN(i,[11 12])*v(1,:)'];
