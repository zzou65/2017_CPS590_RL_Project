...
%   CH-8092 Zurich, Switzerland
  ...
  for i = 1:NREFS
    ...
    % Assemble matrices and load vectors (discontinuous Crouzeix-Raviart elements)
    ...
    Lbnd = assemLoad_Bnd_DG(Mesh,@LOAD_Bnd_DGCR,QuadRule_1D,S,SIGMA,UD);
    ...
    L2Err(i) = L2Err_DGCR(Mesh,U,QuadRule_2D,UEX);
    H1SErr(i) = H1SErr_DGCR(Mesh,U,QuadRule_2D,GRAD_UEX);
