...
%   CH-8092 Zurich, Switzerland
  ...
  SHAP = @shap_LFE;                                               % Shape functions
  GRAD_SHAP = @grad_shap_LFE;                                     % Gradients of shape functions
  ...
  fig = figure('Name','Discretization error for linear FE');
  plot(h,L2Err_sym,'r-+', ...
       h,L2Err_asym,'b-+');
  title('{\bf Discretization error for linear FE}');
