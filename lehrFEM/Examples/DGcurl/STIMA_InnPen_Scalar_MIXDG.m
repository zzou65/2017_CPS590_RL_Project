function Jloc = STIMA_InnPen_Scalar_MIXDG(Edge,Normal,BdFlag,LData,RData,SHandle,varargin)
% STIMA_INNPEN_SCALAR_MIXDG Element stiffness matrix for interior penalty term.
%
%   JLOC = STIMA_INNPEN_SCALAR_MIXDG(EDGE,NORMAL,BDFLAG,LDATA,RDATA,SHANDLE)
