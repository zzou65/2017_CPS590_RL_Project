function Jloc = STIMA_InnPen_Tangent_DGLFE2(Edge,Normal,BdFlag,LData,RData,SHandle,varargin)
% STIMA_INNPEN_TANGENT_DGLFE2 Element stiffness matrix for interior tangential penalty term.
%
