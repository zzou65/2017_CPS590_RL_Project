function Jloc = STIMA_BndPen_MIXDG2(Edge,Normal,BdFlag,LData,varargin)
% STIMA_BNDPEN_MIXDG2 Element stiffness matrix for interior penalty term.
%
%   JLOC = STIMA_BNDPEN_MIXDG2(EDGE,NORMAL,BDFLAG,LDATA,RDATA,SHANDLE)
