function [] = table_circadv()
% generate data tables for circula advection

%   Note : geometric multigrid diverges on the second coarsest level with
