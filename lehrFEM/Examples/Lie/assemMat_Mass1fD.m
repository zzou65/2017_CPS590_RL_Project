function varargout = assemMat_Mass1f(Mesh, varargin)
% assemMat_Mass1fD Assemble diagonal MASS matrix for one forms
%
%   A = assemMat_Mass1fD(Mesh,varargin) 
%   A = ASSEMMat_Mass1fD(MESH) .... and
