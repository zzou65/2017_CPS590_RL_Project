% error_Obstacle2D_psor discretization error analysis
%   Disretization error analysis of the obstacle problem using the
%   projected sor method on a circular mesh with radius 1 and center
...
%   The plot of the error against mesh width is saved as error_psor.eps and
...
for j = 1:N,
  ...
  % Plot out discretization error against mesh width h
  ...
  print -depsc error_psor.eps
  
  % Plot out discretization error against degrees of freedom DF
