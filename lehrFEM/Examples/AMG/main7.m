function [] = main7()
% convergence rates for discontinuous coefficients on circle
%
%   Compares multigrid and algebraic multigrid for discontinuous
%   conductivity.  The conductivity is epsilon inside a circle centered in
%   the domain and one outside the circle.  The circle is not resolved by
%   the mesh; however both geometric and algebraic multigrid methods converge,
%   although convergence of geometric multigrid is slower.
...
%   CH-8092 Zurich, Switzerland
  ...
  title('\bf Convergence of Multigrid Methds for Discontinuous Coefficients on a Circle');
  legend('multigrid','algebraic multigrid','Location','NorthWest','Orientation','vertical');
  grid on;
