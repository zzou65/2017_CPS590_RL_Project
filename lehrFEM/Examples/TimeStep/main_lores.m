% Run script for the theta scheme. 
...
% CH-8092 Zurich, Switzerland
  ...
  u_old = assemLoad_LFE(Mesh,P1O2(),U0_HANDLE);
  u_old = M\u_old;
  
  % Start theta scheme
 
  L_old = assemLoad_LFE(Mesh,P1O2(),F_HANDLE,0);
  ...
  for i = 1:NSTEPS
    ...
    L_new = assemLoad_LFE(Mesh,P1O2(),F_HANDLE,i*dt);
