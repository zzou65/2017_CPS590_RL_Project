...
function main_SemiLagrangianPureCfreeAnaBIT(CFL,NREFS)
...
%close all;
filename= ['./results/BITexample6_',num2str(CFL)];
clear Mesh;
%clear all;
...
Mesh.Coordinates = [ -1 -1; -1 0; -1 1;...
                                        -1/3 -1; -1/3 -1/sqrt(3); -1/3 1/sqrt(3); -1/3 1; ...
                                        2/3 -1; 2/3 0; 2/3 1; ...
                                        1 -1; 1 -1/sqrt(3); 1 1/sqrt(3); 1 1];
Mesh.Elements = [ 1 5 4; 1 2 5; 2 6 5; 2 3 6; 3 7 6;...
                                4 5 8; 5 9 8; 6 9 5; 6 10 9; 6 7 10;...
                                8 12 11; 8 9 12; 9 13 12; 9 10 13;  10 14 13]
Mesh = add_Edges(Mesh);
...
hold on;
plot(mw,cfree(:,1),'rx-',...
    mw,cfree(:,3),'go-','k--','Linewidth',2,'MarkerSize',8);
grid('on');
set(gca,'YScale','log','XScale','log','FontSize',12,'FontWeight','bold');
xlabel('{\bf mesh width}','FontSize',12,'FontWeight','bold');
