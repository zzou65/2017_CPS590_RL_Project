...
for i=1:NREFS
    ...
    P_q1 = assemMat_SemiLagQuad_W1F_strang1(NewMesh, Dir_HANDLE,JvDir_Handle,-tau);
    P_q12nd = assemMat_SemiLagQuad_W1F_strang12nd(NewMesh, Dir_HANDLE,JvDir_Handle,-tau);
