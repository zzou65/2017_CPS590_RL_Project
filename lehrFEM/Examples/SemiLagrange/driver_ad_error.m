...
filename=['./figures/L2ErrAdjoint',sprintf('%1.2f',CFL),'.fig'];
saveas(gcf,filename);
filename=['./figures/L2ErrAdjoint',sprintf('%1.2f',CFL),'.eps'];
print('-depsc', filename);
filename=['./figures/L2ErrAdjoint',sprintf('%1.2f',CFL),'.mat'];
