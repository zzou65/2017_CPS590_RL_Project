...
for j=1:NREFS
    ...
    S_left = c_Dt*M+h*THETA_C*c_CC*C+h*THETA_L*(c_ID*ID+c_DI*DI);
    S_right = c_Dt*M-h*(1-THETA_C)*c_CC*C-h*(1-THETA_L)*(c_ID*ID+c_DI*DI);
    % timestepping
