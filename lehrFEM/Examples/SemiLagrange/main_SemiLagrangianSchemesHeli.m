function main_SemiLagrangianSchemesHeli(CFL,NREFS)
...
for j=1:NREFS
    ...
    time(1,j) = 0;
    L2ErrH(1,j,1) = Helicity2D_W1F(NewMesh,H_old(:,1),P7O6(),Dir_Handle,0);
    L2ErrH(1,j,2) = Helicity2D_W1F(NewMesh,H_old(:,2),P7O6(),Dir_Handle,0);
    L2ErrH(1,j,3) = Helicity2D_W1F(NewMesh,H_old(:,3),P7O6(),Dir_Handle,0);
    L2ErrH(1,j,4) = Helicity2D_W1F(NewMesh,H_old(:,4),P7O6(),Dir_Handle,0);
    L2ErrH(1,j,5) = Helicity2D_W1F(NewMesh,H_old(:,5),P7O6(),Dir_Handle,0); 
    ...
    for i = 1:nsteps
        ...
        L2ErrH(i+1,j,1) = abs(Helicity2D_W1F(NewMesh,H_old(:,1),P7O6(),Dir_Handle,0)-L2ErrH(1,j,1));
        L2ErrH(i+1,j,2) = abs(Helicity2D_W1F(NewMesh,H_old(:,2),P7O6(),Dir_Handle,0)-L2ErrH(1,j,2));
        L2ErrH(i+1,j,3) = abs(Helicity2D_W1F(NewMesh,H_old(:,3),P7O6(),Dir_Handle,0)-L2ErrH(1,j,3));
        L2ErrH(i+1,j,4) = abs(Helicity2D_W1F(NewMesh,H_old(:,4),P7O6(),Dir_Handle,0)-L2ErrH(1,j,4));
        L2ErrH(i+1,j,5) = abs(Helicity2D_W1F(NewMesh,H_old(:,5),P7O6(),Dir_Handle,0)-L2ErrH(1,j,5));
