function Aloc=trace_ipoint(Element,ipoint,velo,Mesh)
% trace_ipoint traces the trajectory definied by point ipoint and velocity
% vector velo. Assuming that ipoint is not on the boundary of the element
%
