% Run script for the hierarchical error estimator.
...
%   CH-8092 Zurich, Switzerland
  ...
  fig = figure('Name','Hierarchical error estimator');
  plot(nDofs,Eta,'r-x', ...
       nDofs,Err,'b-x');
  grid('on');
  set(gca,'XScale','log','YScale','log');
  title('{\bf Convergence rates for hierarchical error estimator}');
  xlabel('{\bf Dofs [log]}');
