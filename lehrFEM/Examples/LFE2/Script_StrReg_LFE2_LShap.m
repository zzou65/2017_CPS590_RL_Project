...
% element on the L-Shaped domain.
...
%   CH-8092 Zurich, Switzerland
    ...
    title('\bfConvergence rate of discretization error for strong regularization on the L-Shaped domain')
    legend('\bf\fontsize{10}StrReg:L2 Norm','\bf\fontsize{10}StrReg:H(Curl) Semi-Norm')
    
    % Generate .eps files
    
    print('-depsc', 'rate_StrReg_LFE2_LShap.eps');
    !gv rate_StrReg_LFE2_LShap.eps &
