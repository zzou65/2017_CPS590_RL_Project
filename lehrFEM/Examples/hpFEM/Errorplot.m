function varargout = Errorplot(U,Mesh,Elem2Dof,p,uex)
% ERRORPLOT plots the difference of the finite element solution U and the
% exact solution UEX
%
%   PLOT_HP(U,MESH,ELEM2DOF,P,UEX) generates a plot of the difference
%   between the piecewise polynomial finite element solution and the exact
%   solution
%
...
%   CH-8092 Zurich, Switzerland
  ...
  for i = 1:nElements
    ...
    exact = uex(RefCoord*BK+ones(nRefCoord,1)*bK);
