function varargout = assemMat_UpLFE(Mesh, VHandle,weights)
...
% Assign output arguments
  ...
  for (f = 1:nF)
     ...
     UP_loc=STIMA_UPLFE([a1; a2; a3],VHandle, MD(eidx));
