...
%   CH-8092 Zurich, Switzerland
    ...
    for i=1:NREFS
        ...
        U_V1 = U(1:offset);
        U_V2 = U(offset+(1:offset));
        U_P = U(2*offset+(1:nCoordinates));
        ...
        Err_L2_P(i) = L2Err_LFE(Mesh,U_P,P7O6(),UEX_Handle_P);
        save rate_TH_Sqr.mat M_W Err_L2_U Err_HCS_U Err_L2_P
    ...
    title('\bf Convergence rate of discretization error for Taylor-Hood elements')
    legend('\bf\fontsize{10}V, L2 Norm','\bf\fontsize{10}V, H1 Semi-norm',...
           '\bf\fontsize{10}P, L2 Norm');
    
    % Generate .eps files
    
    print('-depsc', 'rate_TH_Sqr.eps');
