function varargout= assemMat_SemiLagQuad_W1F_patches(Mesh, defMesh,intersec,varargin)
% 
...
if(nargout > 1)
    ...
    varargout{1} = sparse(I(1:loc(1)-1),J(1:loc(1)-1),A(1:loc(1)-1),nEdges,nEdges);
end
