% Run script for the convergence rate for weak regularization W1F finite 
% element solver on the L-Shaped domain.
...
%   CH-8092 Zurich, Switzerland
    ...
    F_Handle = @(x,varagin)[zeros(size(x,1),1) zeros(size(x,1),1)];
    ...
    print('-depsc', 'rate_WRegW1F_LShap.eps');
    !gv rate_WRegW1F_LShap.eps &
